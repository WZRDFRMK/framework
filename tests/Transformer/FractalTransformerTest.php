...
class FractalTransformerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_transform_single_value()
    {
        ...
        // Transform ..
        $this->assertTrue($this->transformer->transform('user', $transformer, array('include1', 'include2')));
    }
    ...
    public function test_transform_collection_array()
    {
        ...
        // Transform ..
        $this->assertTrue($this->transformer->transform(array('user', 'user'), $transformer, array('include1', 'include2')));
    }
    ...
    public function test_transform_collection_pagerfanta()
    {
        // Prepare ..
        $transformer = Mockery::mock('League\Fractal\TransformerAbstract');
        $adapter = new ArrayAdapter(array('user', 'user'));
        ...
        // Transform ..
        $this->assertTrue($this->transformer->transform($pagerfanta, $transformer, array('include1', 'include2')));
    }
